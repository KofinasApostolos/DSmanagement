...
{
    public class LessonsForRegister
    {
        [Required(ErrorMessage = "Lesson ID is required")]
        [StringLength(maximumLength: 4, MinimumLength = 4, ErrorMessage = "Length of Lesson ID cannot extend 4 characters or be less than 4!")]
